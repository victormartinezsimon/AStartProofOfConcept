...
public class MazeGenerator: MonoBehaviour
{
   ...
   // public GameObject paredGirada;
    ...
    private void instanciarSueloNetWork()
    {
        ...
        float aumentoXSuelo = suelo.GetComponent<Renderer>().bounds.size.x;
        float aumentoYSuelo = suelo.GetComponent<Renderer>().bounds.size.y;
        float aumentoZSuelo = suelo.GetComponent<Renderer>().bounds.size.z;
